...
dataPath = '/Download/MNIST/Data/Here';

trainXFileName = [dataPath, 'mnist/train-images-idx3-ubyte'];
trainYFileName = [dataPath, 'mnist/train-labels-idx1-ubyte'];
testXFileName = [dataPath, 'mnist/t10k-images-idx3-ubyte'];
testYFileName = [dataPath, 'mnist/t10k-labels-idx1-ubyte']; 
